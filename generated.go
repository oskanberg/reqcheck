...
func (ec *executionContext) _Query(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "getThing":
			out.Values[i] = ec._Query_getThing(ctx, field)
		case "__type":
...
func (ec *executionContext) _Query_getThing(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	return graphql.Defer(func() (ret graphql.Marshaler) {
		...
		resTmp := ec.FieldMiddleware(ctx, func(ctx context.Context) (interface{}, error) {
			return ec.resolvers.Query().GetThing(ctx, args["id"].(*string))
		})
		if resTmp == nil {
			return graphql.Null
		}
		...
		return ec._Thing(ctx, field.Selections, res)
	})
}
...
func (ec *executionContext) _Thing(ctx context.Context, sel ast.SelectionSet, obj *Thing) graphql.Marshaler {
	fields := graphql.CollectFields(ctx, sel, thingImplementors)
	...
	for i, field := range fields {
		...
		case "prop":
			out.Values[i] = ec._Thing_prop(ctx, field, obj)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
func (ec *executionContext) _Thing_id(ctx context.Context, field graphql.CollectedField, obj *Thing) graphql.Marshaler {
	rctx := graphql.GetResolverContext(ctx)
	rctx.Object = "Thing"
	rctx.Args = nil
	rctx.Field = field
...
func (ec *executionContext) _Thing_prop(ctx context.Context, field graphql.CollectedField, obj *Thing) graphql.Marshaler {
	rctx := graphql.GetResolverContext(ctx)
	rctx.Object = "Thing"
	rctx.Args = nil
	rctx.Field = field
